...
app.get('/', function(req, res) {
  res.send('<html><a href="' + getUrl('twitter') + '">auth twitter</a> or <a href="' + getUrl('facebook') + '">auth facebook</a> or <a href="' + getUrl('instagram') + '">auth instagram</a> or <a href="' + getUrl('foursquare') + '">auth foursquare</a> or <a href="' + getUrl('tumblr') + '">auth tumblr</a></html>');
})
