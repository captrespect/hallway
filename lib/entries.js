...
exports.parseReq = function(path, query)
{
  ...
  if(query.near)
  {
    ...
    if(typeof within != 'number' || isNaN(within) || typeof lat != 'number' || isNaN(lat) || typeof lng != 'number' || isNaN(lng) ) {
      ...
      ret.options.box = {lat:[lat+diff, lat-diff], lng:[lng+diff, lng-diff]};
      ret.options.box.lat.sort(function(a,b){return a-b});
      ret.options.box.lng.sort(function(a,b){return a-b});
    }
  }
