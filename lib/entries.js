...
exports.options = function(query)
{
  var options = {};
...
exports.typist = function(entry, base, type)
{
  ...
  if (type == 'statuses' || type == 'statuses_feed' || (entry.types && entry.types.status)) {
  ...
  if ((!entry.oembed || entry.oembed.type != type) && entry.refs) {
