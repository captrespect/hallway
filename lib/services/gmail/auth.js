module.exports = {
    handler : function (callback, apiKeys, done, req, res) {
        ...
        OA.getOAuthRequestToken( { oauth_callback: callback, scope: 'https://mail.google.com/ http://www.google.com/m8/feeds/' }, function (error, oauth_token, oauth_token_secret, oauth_authorize_url, additionalParameters) {
        console.log("****************************** HERE **********************************");
