...
exports.getCheckins = function (arg, cbEach, cbDone) {
  ...
  arg.uri = (arg.page)?arg.page:'https://graph.facebook.com/'+arg.id+'/checkins?access_token=' + arg.accessToken + '&date_format=U'+since;
...
exports.getAlbum = function (arg, cbEach, cbDone) {
  var since = (arg.since)?"&since="+arg.since:"";
  arg.uri = (arg.page)?arg.page:'https://graph.facebook.com/'+arg.id+'/photos?access_token=' + arg.accessToken + '&date_format=U'+since;
  getDatas(arg, cbEach, cbDone);
}
