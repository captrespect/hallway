...
exports.tweet = {
    ...
    ll: function(data) {
      ...
      return firstLL(data.geo) || firstLL(data.coordinates, true) || (data.place !== null && data.place.bounding_box && data.place.bounding_box.coordinates && computedLL(data.place.bounding_box.coordinates[0]));
