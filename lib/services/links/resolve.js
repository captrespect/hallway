...
exports.pump = function(cset, callback) {
  ...
  var q = async.queue(function(task, cb){
    ...
    expand({url:task.url}, function(arg){
      ...
      if(arg.err) logger.warn("link resolving failed",task.url,arg.err);
...
var APIs = {
    ...
    generic: function (args, callback) {
        ...
        var req = request.head({url:args.url, headers:headers, followRedirect:false, timeout:timeout}, function(err, res){
