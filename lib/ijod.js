...
IJOD.prototype.addData = function(arg, callback) {
  ...
  this.startAddTransaction(function() {
    ...
    self.db.query("REPLACE INTO ijod VALUES (?, ?, ?, ?, ?, ?, ?)", [idr.hash(entry.idr), self.base, self.path, hash, arg.at, offset, (self.len - offset)], callback);
  });
}
...
exports.pump = function(arg, cbDone) {
  ...
  exports.batchSmartAdd(arg, function(error) {
    cbDone(err ? err : null, err ? null : arg);
  });
};
