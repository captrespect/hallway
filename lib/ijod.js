...
exports.getBounds = function(basePath, range, cbDone) {
  ...
  // Bounds stuff is not important here, in fact detrimental filesort potential.  Deprecated for removal unless someone proves otherwise -- temas - 5/18/2012
  /*
  sql += qq(range.q);
  sql += " ORDER BY at DESC";
  if (range.limit) {
