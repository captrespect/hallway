...
insert ignore into Entries (base, idr, path, hash, offset, len, lat, lng, q0, q1, q2, q3) select unhex(substr(concat(rpad(binary base,32,'0'), lpad(hex(floor(at/1000)),8,'0'), substr(binary idr,1,16)),1,56)), unhex(idr), path, hash, offset, len, lat, lng, q0, q1, q2, q3 from ijod
